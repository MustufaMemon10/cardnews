...
import 'package:cardnews/splashscreen.dart';
...
class Newsdata extends State<Newsapp> {
  ...
  Widget build(BuildContext context) {
    if (newsdata == null || newsdata!.isEmpty) {
      ...
      return  Scaffold(
        body: Center(
          child: Lottie.asset('assets/Animation - 1714901035385.json',height: 300,width: 300,repeat: true)
        ),
      );
    }
      ...
      appBar: AppBar(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(width: 0.5,color: AppColors.purple.withOpacity(0.7)),
